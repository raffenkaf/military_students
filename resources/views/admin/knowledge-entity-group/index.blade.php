<x-admin-layout>
    <div class="p-3">
        ...
        <header class="p-2 w-full flex justify-end">
            <div>
                <a href="{{ route('admin.knowledge-entity-groups.create') }}"
                ...
                @foreach($entityGroups as $entityGroup)
                    <tr class="flex flex-row border-2 border-collapse">
                        ...
                        <td class="flex-1 border-2 border-collapse">
                            <div class="flex h-full align-middle justify-center items-center">
                                <a
                                    href="{{ route('admin.knowledge-entity-groups.knowledge-entities', ['knowledgeEntityGroup' => $entityGroup]) }}"
                        ...
                        <td class="flex-1 border-2 border-collapse">
                            <div class="flex h-full align-middle justify-center items-center">
                                <a
                                    href="{{ route('admin.knowledge-entity-groups.edit', ['knowledgeEntityGroup' => $entityGroup]) }}"
                                    class="py-1 px-3 my-1 rounded-3xl bg-blue-100 hover:bg-blue-200">
                                    Редагувати
                                </a>
                            </div>
                        ...
                        <td class="flex-1 border-2 border-collapse">
                            <form
                                action="{{ route('admin.knowledge-entity-groups.delete', ['knowledgeEntityGroup' => $entityGroup]) }}"
                                method="POST"
