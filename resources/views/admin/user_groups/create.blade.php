    ...
    <div class="p-3">
        <form action="{{ route('admin.user-group.store') }}" method="POST">
            ...
            <div class="flex justify-center">
                <a href="{{ route('admin.user-groups') }}" class="py-1 mx-2 px-10 mt-4 my-1 rounded-3xl bg-gray-200 hover:bg-gray-300">
                    Назад
                </a>
                <button type="submit" class="py-1 px-10 mr-2 my-1 rounded-3xl bg-blue-100 hover:bg-blue-200">
                    Створити
                </button>
            </div>
        </form>
